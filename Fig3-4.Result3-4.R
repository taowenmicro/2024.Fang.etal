...
repath = "./result_and_plot/Data.mining/Fig3-4/"
...
repath = "./result_and_plot/Data.mining/Fig3-4_NEW/"
path = paste0(repath,"./bio.rna.compounds_2/")
fs::dir_create(path)
ggsave(paste(path,"bionetwork2.pdf",sep = ""),  p,width = 11,height = 10,limitsize = FALSE)
...
p0 <- ggplot() + geom_segment(aes(x = X1, y = Y1, xend = X2, yend = Y2,color = as.factor(cor)),
  ...
  theme_void()
# p0
ggsave(paste(path,"bionetwork.label.pdf",sep = ""),  p0,width = 30,height = 30,limitsize = FALSE)
...
fs::dir_create(path)
ggsave(paste(path,"bionetwork2.pdf",sep = ""),  p,width = 11,height = 13,limitsize = FALSE)
...
fs::dir_create(path)
ggsave(paste(path,"bionetwork2.pdf",sep = ""),  p,width = 26,height = 12,limitsize = FALSE)
...
p0 <- ggplot() + geom_segment(aes(x = X1, y = Y1, xend = X2, yend = Y2,color = as.factor(cor)),
  ...
  theme_void()
# p0
ggsave(paste(path,"bionetwork.label.pdf",sep = ""),  p0,width = 60,height = 33,limitsize = FALSE)
...
fs::dir_create(path)
ggsave(paste(path,"bionetwork2.pdf",sep = ""),  p,width = 36,height = 22,limitsize = FALSE)
...
p0 <- ggplot() + geom_segment(aes(x = X1, y = Y1, xend = X2, yend = Y2,color = as.factor(cor)),
  ...
  theme_void()
# p0
ggsave(paste(path,"bionetwork.label.pdf",sep = ""),  p0,width = 60,height = 60,limitsize = FALSE)
...
fs::dir_create(path)
ggsave(paste(path,"bionetwork2.pdf",sep = ""),  p,width = 13,height = 12,limitsize = FALSE)
